<template>
    <div class="absolute inset-0 w-screen h-screen bg-purple-800 flex justify-center items-center">
      ...
      <form @submit.prevent class="space-y-4">
        ...
        <div>
          <button v-if="noteToEdit" @click="saveNote" class="w-full bg-green-500 text-green-800 p-2 rounded mt-4 hover:bg-green-600 hover:text-green-900">
            Save</button>

          <button v-else @click="addNote" class="w-full bg-yellow-500 text-yellow-800 p-2 rounded mt-4 hover:bg-yellow-600 hover:text-yellow-900">
             Add </button>
