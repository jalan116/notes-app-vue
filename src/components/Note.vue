<template>
    <div class="bg-yellow-400 text-yellow-800 rounded text-center p-2 space-y-2">
      ...
      <div class="flex justify-end space-x-2">
        <button @click="editNote(note)" class="hover:text-green-800"><mdi:playlist-edit /></button>
        <button @click="removeNote($props.note.id)" class="hover:text-red-800"><raphael:trash /></button>
      </div>
    </div>
  </template>
